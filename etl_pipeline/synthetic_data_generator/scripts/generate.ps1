...
# Look in parent directory (etl_pipeline/synthetic_data_generator/) where .env_demo lives
...
if (Test-Path $envFile) {
    ...
    Write-Host "📄 No .env_demo file found at: $envFile" -ForegroundColor Gray
    Write-Host "   Using CLI arguments or defaults" -ForegroundColor Gray
}
...
$generatorDir = Split-Path $PSScriptRoot -Parent
