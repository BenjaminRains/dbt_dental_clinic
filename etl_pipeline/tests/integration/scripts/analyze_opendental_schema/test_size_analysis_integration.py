...
This module tests table size analysis against the actual clinic OpenDental database
...
Coverage Areas:
- Real clinic size analysis from actual database
...
class TestSizeAnalysisIntegration:
    ...
    def test_clinic_table_size_analysis(self, clinic_settings_with_file_provider):
        """
        ...
        AAA Pattern:
            ...
            Assert: Verify real clinic table size information is correctly extracted
