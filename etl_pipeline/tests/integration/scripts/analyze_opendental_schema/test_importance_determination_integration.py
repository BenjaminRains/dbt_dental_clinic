# tests/integration/scripts/analyze_opendental_schema/test_importance_determination_integration.py

"""
Integration tests for table importance determination with real production database connections.

This module tests table importance determination against the actual production OpenDental database
to validate real table classification, importance criteria, and business logic.

Production Test Strategy:
- Uses production database connections with readonly access
- Tests real importance determination with actual production database data
- Validates table classification with real production data
...
- Validates actual production database connections and importance determination
"""
...
@pytest.mark.order(5)  # After size analysis tests
@pytest.mark.mysql
@pytest.mark.etl_critical
@pytest.mark.provider_pattern
@pytest.mark.settings_injection
@pytest.mark.production
class TestImportanceDeterminationIntegration:
    """Integration tests for table importance determination with real production database connections."""
