...
class Settings:
    ...
    def _detect_environment() -> str:
        ...
        from .settings_v2 import ETLStage, resolve_etl_stage
        ...
        try:
            ...
            valid_environments = [s.value for s in ETLStage]
            invalid_value = os.getenv("ETL_ENVIRONMENT", "unknown")
            raise ConfigurationError(
                message=message,
                invalid_values={"ETL_ENVIRONMENT": invalid_value},
