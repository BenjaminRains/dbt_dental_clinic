...
procedure_fees_enhanced as (
    select
        ...
        {{ convert_opendental_boolean('fs.is_hidden') }} as is_fee_schedule_hidden,
        {{ convert_opendental_boolean('fs.is_global_flag') }} as is_global_fee_schedule,
        ...
        {{ convert_opendental_boolean('pc.is_hygiene_flag') }} as is_hygiene_procedure,
        {{ convert_opendental_boolean('pc.is_prosthetic_flag') }} as is_prosthetic_procedure,
        {{ convert_opendental_boolean('pc.is_multi_visit_flag') }} as is_multi_visit_procedure,
...
fee_model_integrated as (
    select
        ...
        p._extracted_at,
        p._created_at,
        coalesce(p._updated_at, p._created_at) as _updated_at,
...
final as (
    select * from fee_model_integrated
