    ...
    from (
        select
            ...
            case
                ...
                -- Date validations
                when date_created > current_timestamp then 'Creation date cannot be in future'
                when date_updated > current_timestamp then 'Update date cannot be in future'
                when date_created is not null and date_updated < date_created 
                ...
                when primary_provider_id = secondary_provider_id 
                    ...
                    and date_updated > current_timestamp - interval '30 days'
