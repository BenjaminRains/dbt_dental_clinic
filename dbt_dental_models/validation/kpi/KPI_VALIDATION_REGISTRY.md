...
| compare_sql_draft | [daily-production-by-procedure](./daily-production-by-procedure/) | Daily production by procedure | `fact_procedure` | `sum(actual_fee)` by `date_complete` | Production by Procedure | Reports → Standard → Daily → Production by Procedure | ±0.5% or ±$10 | **1/3 golden dates PASS (2026-06-26):** [2026-06-10](./daily-production-by-procedure/findings/2026-06-10.md) — layers 0–3 PASS local after [ETL-FND-001](../../../docs/etl/findings/ETL-FND-001-replica-row-drift-procedurelog.md) fix. Need 2+ more spot-check dates for `within_tolerance`. |
