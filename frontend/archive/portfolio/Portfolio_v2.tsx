        ...
        <Box sx={{ minHeight: '100vh', bgcolor: 'background.default' }}>
            ...
            >
                <Container maxWidth="md" sx={{ textAlign: 'center' }}>
                    ...
                    >
                        Data Engineer ΓÇô Healthcare Analytics & Modern ELT
                    </Typography>
                    <Typography
                        variant="body2"
                        component="div"
                    ...
                    >
                        Las Vegas, NV ΓÇó rains.bp@gmail.com ΓÇó{' '}
                        <Link
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} md={8}>
                            <Typography variant="body2" color="text.secondary" sx={{ textAlign: 'left' }}>
                                ...
                                20,000 procedures with full referential integrity and business logicΓÇö100% HIPAA compliant.
                            </Typography>
                        </Grid>
                        <Grid item xs={12} md={4}>
                            <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <Card elevation={3}>
                            <CardContent>
                                ...
                                <Typography variant="body2" color="text.secondary" paragraph>
                                    ...
                                    RDS) for reliable daily updates and frictionless deployments to the clinicΓÇÖs
